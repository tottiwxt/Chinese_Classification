...
sentenct_output = open(data_root+'\standard\SST-2/sentences.txt','a',encoding='utf-8')
label_output = open(data_root+'\standard\SST-2/labels.txt','a',encoding='utf-8')

sentence_phrase_output = open(data_root+'/standard/SST-2/big_train.txt','a',encoding='utf-8')
