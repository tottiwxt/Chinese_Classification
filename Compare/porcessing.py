...
base_directory  = "D:\Topic\code\segment\compare\dataset\stanfordSentimentTreebank"
output_directory = "D:\Topic\code\segment\compare\dataset\stanfordSentimentTreebank\output"
